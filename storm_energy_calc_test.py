from metpy_dataframe_loader import load_and_convert_sounding
from calculations.storm_energy import makeStormEnergy
import os

name = "snd-20090609-235406-storm1-10m.zagl"
sounding = load_and_convert_sounding(name)

storm_energy = makeStormEnergy(sounding) 
...
for file_name in all_files:
  ...
  energy = makeStormEnergy(sounding)
  if not energy:
